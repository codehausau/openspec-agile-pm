...
2. **Resolve change context**
   ...
   the approval preflight before reading or writing main specs. Read the current
   product-approval instructions and concrete PRD-set paths from `artifactPaths`,
